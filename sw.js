...
const CACHE = "ledger-ai-v211";
const SHELL = ["./app.html", "./public-recovery.js?v=1", "./security.js?v=2", "./assets/vendor/xlsx-0.20.3.mjs", "./app.js?v=177", "./index.html", "./manifest.webmanifest", "./icon.svg",
