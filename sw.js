...
const CACHE = "ledger-ai-v225";
const SHELL = ["./login-offers.js?v=1", "./account-boundary.js?v=3", "./app.html", "./public-recovery.js?v=2", "./security.js?v=6", "./assets/vendor/xlsx-0.20.3.mjs", "./app.js?v=186", "./index.html", "./manifest.webmanifest", "./icon.svg",
