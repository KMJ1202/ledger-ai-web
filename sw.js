...
const CACHE = "ledger-ai-v216";
const SHELL = ["./login-offers.js?v=1", "./account-boundary.js?v=1", "./app.html", "./public-recovery.js?v=1", "./security.js?v=3", "./assets/vendor/xlsx-0.20.3.mjs", "./app.js?v=182", "./index.html", "./manifest.webmanifest", "./icon.svg",
